function [push_down] = bg_push_down_thresh(img,threshold,expand_pixel,Pixel_Ang,Inside_Radius_Ang,Outside_Radius_Ang)
...
y2 = y2_A + value_y2_B .* exp(i .* angle_y2_ori_B)  ; 
